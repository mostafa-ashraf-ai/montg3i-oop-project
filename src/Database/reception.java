 ...
 */
    ...
    public static boolean checkUserAndPass(String username, String password)
    {
        try {
            ...
            String strCheck = "SELECT username,pass FROM reception WHERE username = '" + username + "' and pass = '" + password + "'";
    ...
    public static void Add(String ColumnName, String value)
    {
        try
        {
            setConnection();
            Statement stmt = con.createStatement();
            String str = "INSERT INTO reception (" + ColumnName + ") VALUES ('" + value + "')";
    ...
    public static void Add(int id, String username,String pass,String FirstName,String LastName,String email)
    {
        try
        {
            setConnection();
            Statement stmt = con.createStatement();
            String str = "INSERT INTO reception VALUES (" + id + ",'" + username + "','" + pass + "','" + FirstName + "','" + LastName + "','" + email + "')";
            stmt.executeQuery(str);
            con.close();
        }
        catch(SQLException ex)
    ...
    public static void Update(String ColumnName, String value, int id)
    {
        try
        {
            setConnection();
            Statement stmt = con.createStatement();
            String str = "UPDARE reception SET " + ColumnName + " = '" + value + "' WHERE ID = " + id;
            stmt.executeQuery(str);
            con.close();
        }
        catch(SQLException ex)
    ...
    public static void Delete(int id)
    {
        try
        {
            setConnection();
            Statement stmt = con.createStatement();
            String str = "DELETE FROM reception WHERE ID = " + id;
            stmt.executeQuery(str);
            con.close();
        }
        catch(SQLException ex)
